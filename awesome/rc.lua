...
beautiful.init("/home/eber/.config/awesome/theme/theme.lua")


-- This is used later as the default terminal and editor to run.
terminal = "urxvt"
editor = os.getenv("EDITOR", "vim") or "nano"
...
for s = 1, screen.count() do
    ...
    --tags[s] = awful.tag({ 1, 2, 3, 4, 5, 6, 7, 8, 9 }, s, tags.layout[1])
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "e",      function () awful.util.spawn( "icecat" ) end),
